  ...
  <div className="d-flex flex-column justify-content-center align-items-center m-1 m-md-3 text-white">
    <div className="bombo p-3 p-md-4 position-relative" style={{ width: "95%", maxWidth: "600px" }}>
      <div className="position-absolute" style={{ top: "15px", right: "20px" }} ref={menuRef}>
        ...
        {showMenu && (
          <div
            className="bg-dark border border-secondary rounded p-2 shadow"
      ...
      {feltoltotkep && !szoveg && (
        <div className="d-flex justify-content-center m-2">
          <img
            className="img-fluid"
            style={{ maxHeight: "400px", objectFit: "cover", borderRadius: "25px", width: "100%" }}
      ...
      {feltoltotkep && szoveg && (
        <div
          ...
          style={{ background: "#333333", borderRadius: "25px", overflow: "hidden" }}
        >
      ...
      >
        ...
        >
          <button
            ...
            style={{ top: "10px", right: "15px", zIndex: 10, fontSize: "24px" }}
          ...
          <div className="d-flex h-100 flex-column flex-md-row">
            <div className="col-md-6 p-4 d-flex flex-column border-end border-dark border-opacity-10">
              ...
              <div className="flex-grow-1 overflow-auto">
                ...
                <div className="bg-light p-3 rounded" style={{ fontSize: "14px" }}>
                  {szoveg}
                </div>
              </div>
            </div>
            ...
            <div className="col-md-6 p-4 d-flex flex-column bg-white bg-opacity-10">
                ...
                <div className="no-scroll">
                  {comments.map((c) => (
                    <div key={c.id} className="mb-3 text-end">
                      ...
                      <div className="bg-white d-inline-block p-2 px-3 rounded-pill shadow-sm" style={{ fontSize: "13px" }}>
                        {c.szoveg}
                      </div>
              ...
              <div className="mt-3 position-relative">
                ...
                />
                <button onClick={handleSendComment} className="btn position-absolute end-0 top-0 mt-1 me-2">
                  Küldés
                </button>
              </div>
            </div>
